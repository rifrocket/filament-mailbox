<x-filament-panels::page
    @class([
        ...
        'fi-resource-' . str_replace('/', '-', $this->getResource()::getSlug().'arif'),
    ])
>
    <div class="flex flex-col md:flex-row gap-4"> <!-- changed container for responsiveness -->
        <div class="justify-between"> <!-- responsive width adjustment -->
            ...
            <x-filament::tabs class="flex flex-col">
        ...
        <div class="flex-1">
            ...
            <div class="overflow-x-auto w-full  "> <!-- added responsive table wrapper -->
                {{ $this->table }}
            </div>
